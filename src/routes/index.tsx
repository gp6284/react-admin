...
const RooMManagement = lazy(() => import(/* webpackChunkName: "404'"*/ 'pages/roommanagement'));
const AddNewRoom = lazy(() => import(/* webpackChunkName: "404'"*/ 'pages/addNewRoom'));
...
const routeList: PartialRouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'roommanagement',
        element: <WrapperRouteComponent element={<RooMManagement />} titleId="title.roommanagement" />
      },
      {
        path: 'newroom',
        element: <WrapperRouteComponent element={<AddNewRoom />} titleId="title.addnewroom" />
      },
      {
        path: 'guide',
